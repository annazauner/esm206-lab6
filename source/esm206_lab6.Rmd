...
If these samples came from populations with the same ranks, then there is a 28% chance that randomly selected samples would have ranks as different as those in our sample. This is likely therefore we can retain the null hypothesis. There is no significant differences in the ranks between group 1 and group 2. 
